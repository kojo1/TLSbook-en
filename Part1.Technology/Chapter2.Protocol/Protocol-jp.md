...
<br><br>
![表2-3 TLS1.3における鍵導出スケジュール](./table2-3.gif)<br>
 [表2-3 TLS1.3における鍵導出スケジュール](./table2-3.md)
<br><br>
...
<br><br>
![表2-4 TLS1.3で使用できる署名スキーム一覧](./table2-4.gif)<br>
 [表2-4 TLS1.3で使用できる署名スキーム一覧](./table2-4.md)
<br><br>

#### 5) 証明書の有効性確認
証明書の有効性確認は当初CRLやOCSPのようにTLSハンドシェークのスコープ外で実現されていました。OCSP Stapling ではハンドシェークの一部としてTLS拡張に取り込まれていますが、その具体的なしくみについては９章 証明書で解説します。
...
参照RFC：
[表2-3: TLS1.3関連RFC](table2-6-TLS-RFC.md)
